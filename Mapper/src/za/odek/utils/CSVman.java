...
public class CSVman {
 ...
 // private static final String FILENAME_IR = "data/csvtest_in.csv";
  ...
  public static void main(String[] args) {
    Reader iCvs = null;
    Writer oCvs = null;
    System.out.println(textFileContentsToString("C:\\Users\\Kiran Pasuluri\\Desktop\\useraccounts.csv"));
    try {
      iCvs = new BufferedReader(new FileReader("C:\\Users\\Kiran Pasuluri\\Desktop\\useraccounts.csv"));
      oCvs = new BufferedWriter(new FileWriter("C:\\Users\\Kiran Pasuluri\\Desktop\\useraccounts.csv"));
